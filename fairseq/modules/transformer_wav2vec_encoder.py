...
class TransformerWav2VecEncoder(nn.Module):  #We might not need this part since we are already getting embeddings...
    """
    ...
    def forward(
        ...
        if self.embed_positions is not None:
            ...
            x += self.embed_positions(x, positions=positions)
