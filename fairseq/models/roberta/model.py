...
class RobertaEncoder(FairseqDecoder):
    ...
    def __init__(self, args, dictionary):
        ...
        self.args = args
        self.sentence_encoder = TransformerSentenceEncoder(        #This encodes the sentences
        ...
        self.lm_head = RobertaLMHead(  #Prediction head
...
# @register_model_architecture('roberta', 'emo')
# def emo_architecture(args):
#     args.encoder_layers = getattr(args, 'encoder_layers', 24)
#     args.encoder_embed_dim = getattr(args, 'encoder_embed_dim', 1024)
#     args.encoder_ffn_embed_dim = getattr(args, 'encoder_ffn_embed_dim', 4096)
#     args.encoder_attention_heads = getattr(args, 'encoder_attention_heads', 16)
