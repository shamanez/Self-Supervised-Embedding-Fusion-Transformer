...
class RawAudioDataset(FairseqDataset):
    ...
    def __init__(self, manifest_path, sample_rate, max_sample_size=None, min_sample_size=None,
        ...
        """
        Read file paths for audio and video    
        """
    ...
    def collater(self, samples):
        ...
        for i, (source, size) in enumerate(zip(sources, sizes)):
            ...
            if diff == 0:
                ...
                delta = abs(diff)
                collated_sources[i] = np.pad(collated_sources[i], (0, delta), mode = 'edge')
    ...
    def ordered_indices(self):
        ...
        if self.shuffle:
            ...
            order = [np.random.permutation(len(self))]  #Indices which are similar to the length of the dataset
