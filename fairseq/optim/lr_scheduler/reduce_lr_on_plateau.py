...
class ReduceLROnPlateau(FairseqLRScheduler):
    ...
    def __init__(self, args, optimizer):
        ...
        self.lr_scheduler = torch.optim.lr_scheduler.ReduceLROnPlateau(  #factor = 0.1 
            self.optimizer.optimizer, patience=0, factor=args.lr_shrink,  #threshold = 0.0001
            threshold=args.lr_threshold)                              #previously patience 0
